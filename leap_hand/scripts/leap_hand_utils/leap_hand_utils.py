...
def LEAP_limits():
    ...
    # muj_lower = torch.tensor([-0.314, -1.047, -0.506, -0.366,
    #                                -0.314, -1.047, -0.506, -0.366,
    #                                -0.314, -1.047, -0.506, -0.366,
    #                                -0.349, -0.349, -0.47,  -1.34 ], dtype=torch.float, device=self.device)
    # muj_upper = torch.tensor([2.23, 1.047, 1.885, 2.042,
    #                                2.23, 1.047, 1.885, 2.042,
    #                                2.23, 1.047, 1.885, 2.042,
    #                                2.094, 2.094, 2.443, 1.88 ], dtype=torch.float, device=self.device)
